...
namespace MeetupApi.Infrastructure.Migr.SqlServer.Migrations
{
    ...
    [Migration("20221130222737_newData")]
            ...
            modelBuilder.Entity("MeetupApi.Domain.Core.Entities.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Date = new DateTime(2022, 12, 1, 1, 27, 36, 957, DateTimeKind.Local).AddTicks(5276),
            ...
            modelBuilder.Entity("MeetupApi.Domain.Core.Entities.Plan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EventId = new Guid("01abbca8-664d-4b20-b5de-024705497d4a"),
                            Time = new DateTime(2022, 12, 1, 1, 27, 36, 957, DateTimeKind.Local).AddTicks(5354)
                        },
                        new
                        {
                            ...
                            EventId = new Guid("01abbca8-664d-4b20-b5de-024705497d4a"),
                            Time = new DateTime(2022, 12, 1, 1, 27, 36, 957, DateTimeKind.Local).AddTicks(5358)
                        });
                });
